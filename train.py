...
def prompt_and_decoder(args, batched_input, model, image_embeddings, decoder_iter=False):
    ...
    if decoder_iter:
        ...
        # dense embedding的维度是torch.Size([20, 256, 16, 16])
...
def train_one_epoch(args, model, optimizer, train_loader, epoch, criterion):
    ...
    for batch, batched_input in enumerate(train_loader):
        ...
        for n, value in model.image_encoder.named_parameters():
            if "mamba_layers" in n or "2.attn.rel_pos" in n or "5.attn.rel_pos" in n or "8.attn.rel_pos" in n or "11.attn.rel_pos" in n or "combiner" in n or "Adapter" in n:
